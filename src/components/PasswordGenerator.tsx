...
import { Link } from 'react-router-dom'; // <-- IMPORTANT: This import makes the links work
...
export default function PasswordGenerator() {
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle py-8 px-4 relative overflow-hidden">
      ...
      {/* This header contains the login/signup buttons */}
      <header className="max-w-5xl mx-auto mb-8 flex justify-end items-center">
